...
//          Postcondition: If target was in the bag, the one copy has been removed;
...
//          Postcondition: The return value is the total items in the bag.
//
...
//          Postcondition: The bag returned is the union of bag1 and bag2.
//
// VALUE SEMANTICS for the bag class:
//      Assignment and copy constructor may be used with bag objects.
...
class bag
{
    public:
        ...
        size_type erase(const value_type& target);
        void operator +=(const bag& addend);
        void operator -=(const bag& minusend);
